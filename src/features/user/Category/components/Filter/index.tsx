      ...
      <div className={cx("filter__item")}>
        ...
        <div className={cx("filter__price__container")}>
          <div className={cx("filter__price__container__min")}>
            <label
              htmlFor="min"
              className={cx("filter__price__container__min__label")}
            >
              From
            </label>
            <Input
              ...
              onChange={(val) =>
                handlePriceRangeChange(Number(val), priceRange[1])
              }
            />
          </div>
          <div className={cx("filter__price__container__max")}>
            <label
              htmlFor="max"
              className={cx("filter__price__container__max__label")}
            >
              To
            </label>
            <Input
              ...
              onChange={(val) =>
                handlePriceRangeChange(priceRange[0], Number(val))
              }
            />
          </div>
        </div>
        ...
        <div className={cx("filter__brand__container")}>
          <div className={cx("filter__brand__container__item")}>
            <input
              ...
              name="brand1"
              value="brand1"
              className={cx("filter__brand__container__item__input")}
            />
            <label
              htmlFor="brand1"
              className={cx("filter__brand__container__item__label")}
            >
              Brand 1
            </label>
          </div>
